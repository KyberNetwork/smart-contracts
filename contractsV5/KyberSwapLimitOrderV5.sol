...
import "./KyberNetworkProxyInterfaceV5.sol";
import "./zeppelin/SafeERC20V5.sol";
import "./zeppelin/SafeMathV5.sol";
import "./WithdrawableV5.sol";


contract KyberSwapLimitOrderV5 is WithdrawableV5 {

    //userAddress => concatenated token addresses => nonce
    mapping(address => mapping(uint256 => uint256)) public nonces;
    bool public tradeEnabled;
    KyberNetworkProxyInterfaceV5 public kyberNetworkProxy;
    uint256 public constant MAX_DEST_AMOUNT = 2 ** 256 - 1;
    uint256 public constant PRECISION = 10**4;
    using SafeMathV5 for uint256;
    using SafeERC20V5 for ERC20;

    //Constructor
    constructor(
        address _admin,
        KyberNetworkProxyInterfaceV5 _kyberNetworkProxy
    )
        public
        WithdrawableV5(_admin) {
