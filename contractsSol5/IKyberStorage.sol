...
contract IKyberStorage {
    ...
    function removeReserve(address reserve, uint256 startIndex) external returns (bytes8 reserveId);
    ...
    function convertReserveIdToAddress(bytes8 reserveId) external view returns (address reserveAddress);
