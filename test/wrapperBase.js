...
contract('WrapBase', function(accounts) {
    it("should init WrapperBase and Wrapped contract, init params.", async function () {
        admin = accounts[0];
        operator1 = accounts[1];
        operator2 = accounts[2];
        alerter = accounts[4];

        //init wrapped contract
        wrapper = WrapBase.new()
