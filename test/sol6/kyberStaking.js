...
contract('nimbleStaking', function(accounts) {
  before("one time init", async() => {
    ...
    NIMToken = await TestToken.new("nimble Network Crystal", "NIM", 18);
    victor = accounts[2];
    loi = accounts[3];
    mike = accounts[4];
  });
  ...
  describe("#Deposit Tests", () => {
    it("Test deposit at beginning of epoch, stakes change as expected", async function() {
      ...
      await NIMToken.transfer(victor, mulPrecision(100));
      await NIMToken.approve(stakingContract.address, mulPrecision(100), {from: victor});
    ...
    it("Test deposit then withdraw at same + different epoch, stakes change as expected", async function() {
      ...
      await NIMToken.transfer(victor, mulPrecision(200));
      await NIMToken.approve(stakingContract.address, mulPrecision(200), {from: victor});
    ...
    it("Test deposit few consecutive epochs + after few epochs, stakes change as expected", async function() {
      ...
      await NIMToken.transfer(victor, mulPrecision(1000));
      await NIMToken.approve(stakingContract.address, mulPrecision(1000), {from: victor});
    ...
    it("Test deposit with many stakers", async function() {
      ...
      await NIMToken.transfer(victor, mulPrecision(1000));
      await NIMToken.approve(stakingContract.address, mulPrecision(1000), {from: victor});
      await NIMToken.transfer(loi, mulPrecision(1000));
      await NIMToken.approve(stakingContract.address, mulPrecision(1000), {from: loi});
      await NIMToken.transfer(mike, mulPrecision(1000));
      await NIMToken.approve(stakingContract.address, mulPrecision(1000), {from: mike});
    ...
    it("Test deposit balances change as expected", async function() {
      ...
      await NIMToken.transfer(victor, mulPrecision(500));
      await NIMToken.approve(stakingContract.address, mulPrecision(500), {from: victor});

      let expectedUserBal = await NIMToken.balanceOf(victor);
      let expectedStakingBal = await NIMToken.balanceOf(stakingContract.address);
      ...
      Helper.assertEqual(expectedUserBal, await NIMToken.balanceOf(victor), "user balance is not changed as expected");
      Helper.assertEqual(expectedStakingBal, await NIMToken.balanceOf(stakingContract.address), "staking balance is not changed as expected");
    ...
    it("Test deposit large amount of tokens, check for overflow", async function() {
      ...
      await NIMToken.transfer(victor, totalAmount);
      await NIMToken.approve(stakingContract.address, totalAmount, {from: victor});
  ...
  describe("#Withdrawal Tests", () => {
    ...
    it("Test withdraw more than current epoch stake, but less than total stake", async function() {
      ...
      // total victor has 400 NIM, at current epoch (1) he has 300 NIM
    ...
    it("Test withdraw at end and beginning of an epoch", async function() {
      ...
      await NIMToken.transfer(mike, mulPrecision(100));
      await NIMToken.approve(stakingContract.address, mulPrecision(100), {from: mike});
      await stakingContract.deposit(mulPrecision(100), {from: mike});

      await NIMToken.transfer(loi, mulPrecision(800));
      await NIMToken.approve(stakingContract.address, mulPrecision(800), {from: loi});
  ...
  describe("#Delegate Tests", () => {
    ...
    it("Test delegate then deposit more at current + next + after few epochs", async function() {
      ...
      await NIMToken.transfer(victor, mulPrecision(400));
      await NIMToken.approve(stakingContract.address, mulPrecision(400), {from: victor});
      await stakingContract.deposit(mulPrecision(100), {from: victor});
    ...
    it("Test delegate from many addresses, stakes change as expected", async function() {
      ...
      await NIMToken.transfer(mike, mulPrecision(400));
      await NIMToken.approve(stakingContract.address, mulPrecision(400), {from: mike});
      await stakingContract.deposit(mulPrecision(100), {from: mike});
    ...
    it("Test delegate circulation, data changes as expect", async function() {
      ...
      await NIMToken.transfer(loi, mulPrecision(400));
      await NIMToken.approve(stakingContract.address, mulPrecision(400), {from: loi});
      await stakingContract.deposit(mulPrecision(300), {from: loi});
  ...
  describe("#GetFunctions Tests", () => {
    ...
    it("Test getStake returns correct data", async function() {
      ...
      await NIMToken.transfer(victor, mulPrecision(200));
      await NIMToken.approve(stakingContract.address, mulPrecision(200), {from: victor});
      await NIMToken.transfer(mike, mulPrecision(200));
      await NIMToken.approve(stakingContract.address, mulPrecision(200), {from: mike});
    ...
    it("Test get latest delegated stake returns correct data", async function() {
      ...
      await NIMToken.transfer(mike, mulPrecision(500));
      await NIMToken.approve(stakingContract.address, mulPrecision(500), {from: mike});

      await NIMToken.transfer(loi, mulPrecision(500));
      await NIMToken.approve(stakingContract.address, mulPrecision(500), {from: loi});
    ...
    it("test get staker data returns correct data", async function() {
      ...
      await NIMToken.transfer(mike, mulPrecision(300));
      await NIMToken.approve(stakingContract.address, mulPrecision(300), {from: mike});
    ...
    it("test get latest staker data returns correct data", async() => {
      ...
      await NIMToken.transfer(loi, mulPrecision(100));
      await NIMToken.approve(stakingContract.address, mulPrecision(100), {from: loi});
  ...
  describe("Test Withdrawal shouldn't revert", () => {
    ...
    it("Test withdraw shouldn't revert with re-entrancy from nimbleDao", async() => {
      ...
      await NIMToken.transfer(maliciousDao.address, mulPrecision(100));
  ...
  describe("#Malicious Staking", () => {
    it("Test withdraw should revert, pass checking but not enough NIM to withdraw", async function() {
      epochPeriod = 10;
      startBlock = currentBlock + 20;
      stakingContract = await MaliciousStaking.new(
        NIMToken.address,
