...
async function setupNetwork
    (NetworkArtifact, networkProxyAddress, NIMAddress, nimbleDaoAddress, admin, operator) {
    ...
    let feeHandler = await FeeHandler.new(admin, network.address, network.address, NIMAddress, burnBlockInterval, admin);
