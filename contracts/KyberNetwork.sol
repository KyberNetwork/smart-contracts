...
contract KyberNetwork is Withdrawable, Utils2, KyberNetworkInterface {
    ...
    // Not sure how linter defines complexity. Anyway, from our point of view, below code follows the required
        ...
        returns(bool)
    {
        ...
        if (destAddress != address(this)) {
            //if dest address is network,  Ether / token already here. no need to transfer.
            //can't reach here if dest token is Ether
