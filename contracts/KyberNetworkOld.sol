...
contract KyberNetworkOld is Withdrawable, Utils3, KyberNetworkInterface, ReentrancyGuard {
    ...
    function KyberNetworkOld(address _admin) public {
        ...
        returns(uint expectedRate, uint slippageRate)
    {
        ...
        ( ,expectedRate) = searchBestRate(src, dest, srcQty, includePermissionless);
    ...
    function getExpectedRateOnlyPermission(ERC20 src, ERC20 dest, uint srcQty)
        ...
        returns(uint expectedRate, uint slippageRate)
    {
        ( ,expectedRate) = searchBestRate(src, dest, srcQty, false);
        slippageRate = expectedRate * 97 / 100;
    }
